...
export function Hero() {
  ...
  <div className="self-stretch flex flex-col justify-start items-center gap-8">
    ...
    <div className="w-[528px] inline-flex justify-center items-center gap-[29px]">
      <div className="flex-1 p-4 bg-[#b89752] rounded-lg outline outline-1 outline-offset-[-1px] outline-[#846932] flex justify-center items-center">
      ...
      <div className="flex-1 p-4 bg-[#3a485d] rounded-lg outline outline-1 outline-offset-[-1px] outline-slate-600 flex justify-center items-center">
        <div className="size- px-4 flex justify-center items-center">
